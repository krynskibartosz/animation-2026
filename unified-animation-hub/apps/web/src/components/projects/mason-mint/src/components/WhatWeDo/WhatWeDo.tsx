        ...
        <div className={styles['WhatWeDo__content']}>
          <div className={styles['WhatWeDo__content_left']}>
            <BackgroundImage
              ...
              parallax
              cover
              src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/about/best_1.jpg"
              alt="image"
          ...
          <ParallaxSection parallaxValues={[300, -100]}>
            <div className={styles['WhatWeDo__content_right']}>
              ...
              <BackgroundImage
                ...
                parallax
                cover
                src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/about/best_2.jpg"
                alt="image"
              />
            </div>
          </ParallaxSection>
