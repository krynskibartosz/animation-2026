...
import { toLoverCaseAndSpacesToHyphen } from '@mason-mint/utils/string/toLoverCaseAndSpacesToHyphen'
    ...
    >
      <div className={styles['product__thumb']}>
        <div
          ...
          style={{
            backgroundImage: `url(/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/category-shadows/${categorySlug}.svg)`,
          }}
        ></div>
