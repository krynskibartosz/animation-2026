...
import { useScroll } from '@mason-mint/hooks/useScroll'

import Container from '@mason-mint/app/layouts/Container'
import NavigationLayout from '@mason-mint/components/Header/ui/NavigationLayout/NavigationLayout'
import { MobileLayout } from './MobileLayout/MobileLayout'

import { Store } from '@mason-mint/utils/Store'
import styles from './Header.module.scss'
import { breakpointTablet } from '@mason-mint/utils/variables'
import { LogoComponent } from '@mason-mint/ui/Logo'
