...
import TextField from '@mason-mint/ui/TextField/TextField'
import { yupResolver } from '@hookform/resolvers/yup'
import { validationSchema } from '@mason-mint/modules/BecomeADistributor/ui/BecomeADistributorForm/validationSchema'
import { browserSendEmail } from '@mason-mint/utils/email/browserSendEmail'
import { useModal } from '@mason-mint/hooks/useModal'
import { ButtonPrimary } from '@mason-mint/ui/ButtonPrimary/ButtonPrimary'
import { OptionInterface } from '@mason-mint/utils/types'
import { countryList } from '@mason-mint/utils/countries/countryList'
import { useInView, motion } from 'framer-motion'
const CustomSelect = dynamic(() => import('@mason-mint/ui/SelectField/SelectField'), {
  ssr: false,
})
const ErrorModal = dynamic(() => import('@mason-mint/modals/Error/Error'), { ssr: false })
const ThanksModal = dynamic(() => import('@mason-mint/modals/Thanks/Thanks'), {
  ssr: false,
})
