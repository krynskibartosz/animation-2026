...
import { BlueDot } from '@mason-mint/ui/BlueDot'
...
import { breakpointMob, breakpointTablet } from '@mason-mint/utils/variables'
    ...
    >
      <div className={styles['stickyContainer']}>
        <div className={styles['BecomeDistributorSection__content']}>
          <VideoComponent src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/video/CTA.mp4" />
          <motion.div
            style={style}
