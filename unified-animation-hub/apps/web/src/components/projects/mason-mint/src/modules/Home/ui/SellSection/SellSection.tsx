...
import { FlipCoinTypes } from '@mason-mint/modules/Home/ui/SellSection/assets/FlipCoinTypes'
          ...
          <ul className={styles['sellSection__content_right']}>
            <li className={styles['sectionWrapper']}>
              <div className={styles['sectionContent']}>
                <BackgroundImage
                  src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/home/front_coin_1.png"
            ...
            <li className={styles['sectionWrapper']}>
              <div className={styles['sectionContent']}>
                <BackgroundImage
                  src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/home/back_coin_1.png"
                  className={styles['image']}
                  quality={100}
                  alt="Coin photo"
                />
