          ...
          <ParallaxSection>
            <div className={styles['WasBorn__content_left']}>
              <BackgroundImage
                ...
                parallax
                cover
                src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/about/pict_1.jpg"
                alt="image"
          ...
          <ParallaxSection parallaxValues={[300, -100]}>
            <div className={styles['WasBorn__content_right']}>
              <BackgroundImage
                ...
                parallax
                cover
                src="/projects/mason-mint/projects/mason-mint/projects/mason-mint/images/about/pict_2.jpg"
                alt="image"
              />
