  ...
  useEffect(() => {
    if (window.matchMedia("(min-width: 1068px)").matches) {
      new hoverEffect({
        ...
        intensity: 0.6,
        imagesRatio: 360 / 288,
        image1: '/obys-clone/images/image3.png',
        image2: '/obys-clone/images/olga.jpg',
        displacementImage: '/obys-clone/images/14.jpg'
      })
      ...
      new hoverEffect({
        ...
        intensity: 0.4,
        imagesRatio: 360 / 320,
        image1: '/obys-clone/images/image1.jpg',
        image2: '/obys-clone/images/image2.jpg',
        displacementImage: '/obys-clone/images/14.jpg'
      })
      ...
      new hoverEffect({
        ...
        intensity: 0.5,
        imagesRatio: 360 / 320,
        image1: '/obys-clone/images/Ochi.png',
        image2: '/obys-clone/images/eyes.png',
        displacementImage: '/obys-clone/images/14.jpg'
      })
      new hoverEffect({
        ...
        intensity: 0.5,
        imagesRatio: 360 / 320,
        image1: '/obys-clone/images/lax.png',
        image2: '/obys-clone/images/Laxer2.png',
        displacementImage: '/obys-clone/images/14.jpg'
      })
      ...
      new hoverEffect({
        ...
        intensity: 0.5,
        imagesRatio: 360 / 288,
        image1: '/obys-clone/images/flow.png',
        image2: '/obys-clone/images/flow2.png',
        displacementImage: '/obys-clone/images/14.jpg'
      })
      ...
      new hoverEffect({
        ...
        intensity: 0.5,
        imagesRatio: 360 / 320,
        image1: '/obys-clone/images/last.png',
        image2: '/obys-clone/images/last2.png',
        displacementImage: '/obys-clone/images/14.jpg'
      })
    }
  }, []);
