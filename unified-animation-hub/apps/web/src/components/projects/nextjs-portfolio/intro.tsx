...
import { useSectionInView } from "@/components/projects/nextjs-portfolio/lib/hooks";
import { useActiveSectionContext } from "@/components/projects/nextjs-portfolio/context/active-section-context";
    ...
    >
        <div className='flex items-center justify-center'>
            <div className='relative'>
                ...
                >
                    <Image 
                        src="/projects/nextjs-portfolio/profile.png" alt="Pooja"
                        width="100"
                        height="100"
                        quality="95"
                        priority={true}
        ...
        >
            <a
                ...
                href='/projects/nextjs-portfolio/PoojaHooda_resume.pdf' 
                download
            >
                Download CV 
                <HiDownload 
            ...
            <a 
                ...
                href='https://www.linkedin.com/in/pooja-hooda-21b473124/' target='_blank'
            >
                <BsLinkedin />
            </a>
            <a 
                ...
                transition borderBlack dark:bg-white/10 dark:text-white/60' 
                href='https://github.com/poojahooda22' 
                target='_blank'
            >
                <BsGithub />
            </a> 
