...
import type { CameraAnimation, ParticleMesh } from '@codrops-scroll/lib/variant-1/types';
import { images, perspectives, cylinderConfig, particleConfig, imageConfig } from '@codrops-scroll/lib/variant-1/data';
import {
  drawImageCover,
  getPositionClasses,
  createCylinderGeometry,
  createParticleGeometry,
} from '@codrops-scroll/lib/variant-1/utils';
import { cylinderVertex, cylinderFragment, particleVertex, particleFragment } from '@codrops-scroll/lib/variant-1/shaders';
import Loader from '@codrops-scroll/components/loader';
import { CodropsFrame } from '@codrops-scroll/components/codrops-frame';
