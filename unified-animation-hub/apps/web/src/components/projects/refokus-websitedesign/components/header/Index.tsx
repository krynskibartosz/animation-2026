        ...
        <div className='w-screen flex  justify-center z-[9]'>
            ...
            >
                <div className='flex items-center gap-[4vw]'>
                    <Image src='/projects/refokus-websitedesign/logo.svg' width={32} height={32} alt="" className='w-[20vw] sm:w-[12vw] lg:w-[8vw] xl:w-[5vw]' />
...
const HeaderWithThemeWrapper = function HeaderWithThemeWrapper(props: any) {
    return (
...
export default HeaderWithThemeWrapper
