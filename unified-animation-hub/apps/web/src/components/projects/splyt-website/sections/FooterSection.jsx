...
const FooterSection = () => {
  ...
  return (
    <footer className="footer-section">
      <img
        src="/splyt-website/assets/images/footer-dip.png"
      ...
      <div className="relative pt-[10vh] md:pt-[20vh] 2xl:h-[110vh]">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          {isMobile ? (
            <img
              src="/splyt-website/assets/images/footer-drink.png"
              alt="Drink illustration"
              className="w-full h-full object-contain"
            />
          ) : (
            <video
              src="/splyt-website/assets/videos/splash.mp4"
              autoPlay
              playsInline
              muted
              loop={false}
          ...
          <div className="md:max-w-lg w-full">
            ...
            <form className="flex items-center justify-between border-b border-[#D9D9D9] py-5 md:mt-10">
              ...
              <button type="submit" aria-label="Subscribe">
                <img src="/splyt-website/assets/images/arrow.svg" alt="Submit" />
              </button>
            </form>
          </div>
        </div>
