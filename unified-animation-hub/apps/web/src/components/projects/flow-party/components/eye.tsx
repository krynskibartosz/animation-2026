...
export default function Eye() {
	...
	return (
		<div
			...
			ref={wrapperRef}>
			<div
				className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[url('/flow-party/assets/sphere.png')] bg-cover rounded-full"
				ref={emojiRef}>
				<div
					...
					<div className="flex flex-1 justify-between">
						<motion.img
							...
							src={"/flow-party/assets/eyes.svg"}
							alt="right eye"
							width={50}
							height={50}
