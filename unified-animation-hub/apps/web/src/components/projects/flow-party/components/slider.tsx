...
import { Sticky } from "@/components/projects/flow-party/components";
import { eventItems } from "@/components/projects/flow-party/constants";
						...
						{eventItems.map((item) => (
							<SwiperSlide key={item.id}>
								<div className="swiper-slide h-[800px] cursor-pointer relative overflow-hidden">
									{item.id === 1 ? (
										<video
											src={"/flow-party/assets/event4.mp4"}
											autoPlay
											loop
											muted
										/>
