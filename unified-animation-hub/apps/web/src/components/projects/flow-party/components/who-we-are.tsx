...
import { AnimatedText } from "@/components/projects/flow-party/components";
				...
				<div className="w-full flex items-center justify-between gap-5 p-10 h-full">
					<div className="w-1/2 flex flex-col justify-between gap-5 relative h-full">
						...
						<div className="absolute top-1/2 -left-1/4 -translate-y-1/2 overflow-hidden">
							<Image
								src="/flow-party/assets/whoweareline.svg"
								alt="whoweareimg"
								width={300}
								height={300}
							/>
					...
					<div
						...
						<Image
							src="/flow-party/assets/flowCurveText.svg"
						...
						<motion.div
							...
							<Image
								src="/flow-party/assets/emoji1.png"
								alt="flowCurveTextImg"
								width={300}
								height={300}
							/>
						...
						<div className="absolute -bottom-[8%] left-[20%]">
							<div className="relative">
								<motion.img
									...
									src={"/flow-party/assets/circlerotation.svg"}
									alt="right eye"
									width={250}
									height={250}
				...
				<div className="w-full flex h-full relative">
					<div
						...
						<motion.div
							...
							<Image
								src="/flow-party/assets/emoji3.png"
								alt="emoji3img"
								width={300}
								height={300}
							/>
					...
					<div className="w-1/2 h-full flex justify-center items-center relative z-50">
						...
						<motion.div
							...
							style={{ y: mq, rotate: mrq }}>
							<Image
								src="/flow-party/assets/emoji2.png"
								alt="emoji2img"
								width={300}
								height={300}
							/>
