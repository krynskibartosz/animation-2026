...
import FullScreenIcon from "@/components/projects/elementis-sotd/components/SVGComponents/FullScreenIcon";
          ...
          >
            <div className="flex h-auto w-full flex-col md:w-[140vh]">
              <div className="flex-1">
                ...
                >
                  <source
                    src="/projects/elementis-sotd/Hero/elementis-fullmp4.mp4"
                    type="Video/mp4"
                  />
                </video>
              </div>
