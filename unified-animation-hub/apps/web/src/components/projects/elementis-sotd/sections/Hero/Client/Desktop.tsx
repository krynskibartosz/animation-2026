...
import PlaySVG from "@/components/projects/elementis-sotd/components/SVGComponents/PlaySVG";
import { useCursor } from "@/components/projects/elementis-sotd/hooks/useCursor";
import Cursor from "@/components/projects/elementis-sotd/components/Client/Cursor";
      ...
      <div className="absolute inset-0 overflow-clip" ref={containerRef}>
        <motion.div style={{ y, maskImage }} className="h-full">
          <video className="size-full object-cover" autoPlay muted loop>
            <source
              src="/projects/elementis-sotd/Hero/elementismp4.mp4"
              type="video/mp4"
            ></source>
          </video>
        </motion.div>
