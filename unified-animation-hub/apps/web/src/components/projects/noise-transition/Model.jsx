...
const model = "/noise-transition/assets/models/energy-can.glb";
...
const Model = (props) => {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      u_textureSize: {
        value: new Vector2(
          materials.Body.map?.source?.data?.width || 1024,
          materials.Body.map?.source?.data?.height || 1024
        ),
      },
    }),
    [colors]
  ...
  const customMaterial = useMemo(() => {
    const mat = materials.Body.clone();
    mat.metalness = 0;
    mat.roughness = 1;
