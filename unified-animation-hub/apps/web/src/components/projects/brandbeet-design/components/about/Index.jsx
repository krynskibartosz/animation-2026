...
// Image imports removed for absolute paths
    ...
    return (
        <div className='part2 w-[100%] bg-secondary'>
            ...
            <div className='bg-primary w-full h-[16vh] sm:h-[18vh] flex items-center justify-center gap-[6vw] sm:justify-evenly'>
                <div>
                    <Image src="/brandbeet-design/assets/images/apple.svg" width={100} height={100} className='w-[7vw] sm:w-[3vw]' alt='apple' />
                </div>
                <div>
                    <Image src="/brandbeet-design/assets/images/ibm.svg" width={100} height={100} className=' w-[12vw] sm:w-[6vw]' alt='ibm' />
                </div>
                <div className=''>
                    <Image src="/brandbeet-design/assets/images/dell.svg" width={100} height={100} className=' w-[12vw] sm:w-[6vw]' alt='dell' />
                </div>
                <div>
                    <Image src="/brandbeet-design/assets/images/hp.svg" width={100} height={100} className=' w-[8vw] sm:w-[3vw]' alt='hp' />
                </div>
                <div>
                    <Image src="/brandbeet-design/assets/images/oral.svg" width={100} height={100} className=' w-[14vw] sm:w-[6vw]' alt='oral' />
                </div>
            </div>
