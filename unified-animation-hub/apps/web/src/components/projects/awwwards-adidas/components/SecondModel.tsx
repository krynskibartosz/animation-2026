...
import { ShirtType, TextureKey } from "@/components/projects/awwwards-adidas/lib/textures";
...
import { shirtColors } from "@/components/projects/awwwards-adidas/lib/colors";
...
export function SecondModel({ shirtType }: { shirtType: ShirtType }) {
  const { nodes } = useGLTF(
    '/awwwards-adidas/models/ShirtScrolling.glb'
