...
import { useShirtSectionTextures } from "@/components/projects/awwwards-adidas/lib/useTextures";
import { createMaterials } from "@/components/projects/awwwards-adidas/lib/material";
import { TextureKey } from "@/components/projects/awwwards-adidas/lib/textures";
import Masking from "./Masking";
import { useRef } from "react";
import useFirstAnimation from "@/components/projects/awwwards-adidas/lib/useFirstAnimation";
...
export function FirstWhiteModel() {
  const { nodes } = useGLTF(
    '/awwwards-adidas/models/white/WhiteStudio.glb'
