...
import { useMainStudioTextures } from "@/components/projects/awwwards-adidas/lib/useTextures";
import { studioTextures } from "@/components/projects/awwwards-adidas/lib/textures";
...
export function MainStudioModel({
  ...
  const { nodes } = useGLTF(
    '/awwwards-adidas/models/main/MainStudio.glb'
